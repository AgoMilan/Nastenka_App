...
export interface ChangeTaskDueDateInput {
  readonly taskId: string;
  readonly dueDate: Date | string | null;
}

/**
 * Use Case: Změna termínu úkolu (ChangeTaskDueDate).
 *
 * Pravidla:
 * 1. Actor musí být přihlášen a aktivní.
 * 2. Board nesmí být smazán.
 * 3. Oprávnění: TASK_CHANGE_DUE_DATE (ASSIGNEE, PARTICIPANT, MANAGER, OWNER, ADMIN).
 * 4. Termín je volitelný (lze nastavit i null pro zrušení termínu).
 */
export class ChangeTaskDueDateUseCase {
